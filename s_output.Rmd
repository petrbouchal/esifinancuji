...
- Paragrafy + kapitál x běžné: `r ptrr::gh_link("CSV", cb_sum_long_csv, "esifinancuji")` | `r ptrr::gh_link("parquet", cb_sum_long_parquet, "esifinancuji")` | `r ptrr::gh_link("Excel", cb_sum_long_xlsx, "esifinancuji")`
- Paragrafy + kompletní druhové třídění: `r ptrr::gh_link("parquet", cb_semisum_long_parquet, "esifinancuji")`
...
Zapsáno v `
`r file.path(cb_codebook_yaml)`` (`r ptrr::gh_link("Github", cb_codebook_yaml, "esifinancuji")`)
